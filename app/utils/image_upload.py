...
class ImageUploadService:
    ...
    async def upload_to_cloudinary(self, file: UploadFile, folder: str = "marketplace") -> str:
    ...
    async def upload_to_s3(self, file: UploadFile, folder: str = "marketplace") -> str:
    ...
    async def upload_image(self, file: UploadFile, folder: str = "marketplace") -> str:
        ...
        if self.cloudinary_enabled:
            ...
            raise HTTPException(status_code=500, detail="No image upload service configured")
