...
from pip._vendor.pygments.lexer import DelegatingLexer, patternLexer, include, \
...
class Python2Lexer(patternLexer):
    """
...
class _PythonConsoleLexerBase(patternLexer):
...
class PythonTracebackLexer(patternLexer):
    """
...
class Python2TracebackLexer(patternLexer):
    """
...
class CythonLexer(patternLexer):
    """
