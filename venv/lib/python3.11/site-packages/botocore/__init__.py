...
_first_cap_pattern = re.compile('(.)([A-Z][a-z]+)')
_end_cap_pattern = re.compile('([a-z0-9])([A-Z])')
# The pattern below handles the special case where some acronym
...
def xform_name(name, sep='_', _xform_cache=_xform_cache):
    ...
    if key not in _xform_cache:
        ...
        s1 = _first_cap_pattern.sub(r'\1' + sep + r'\2', name)
        transformed = _end_cap_pattern.sub(r'\1' + sep + r'\2', s1).lower()
