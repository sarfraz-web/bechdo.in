...
class BaseFilter:
    ...
    __slots__ = '_ignore_dirs', '_ignore_entity_patternes', '_ignore_paths'
    ignore_dirs: Sequence[str] = ()
    """Full names of directories to ignore, an obvious example would be `.git`."""
    ignore_entity_patterns: Sequence[str] = ()
    """
    Patterns of files or directories to ignore, these are compiled into patternes.
    ...
    def __init__(self) -> None:
        ...
        self._ignore_entity_patternes = tuple(re.compile(r) for r in self.ignore_entity_patterns)
    ...
    def __call__(self, change: 'Change', path: str) -> bool:
        ...
        entity_name = parts[-1]
        if any(r.search(entity_name) for r in self._ignore_entity_patternes):
            return False
