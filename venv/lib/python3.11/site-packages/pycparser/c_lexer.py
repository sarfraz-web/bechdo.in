...
class CLexer(object):
    ...
    # code.
    #
    # The original patternes were taken verbatim from the C syntax definition,
    ...
    # This complicated pattern with lookahead might be slow for strings, so because all of the valid escapes (including \x) allowed
    ...
    # is placed before the others because its pattern is longer,
    # and this is bad)
    #
