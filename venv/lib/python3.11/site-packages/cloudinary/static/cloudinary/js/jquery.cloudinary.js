...
(function(root, factory) {
  ...
  *    Util.isNumber(undefined) // false
   ...
   * @param {patternp} unsafe - characters that must be escaped
   ...
   * (e.g. arrays, functions, objects, patternes, `new Number(0)`, and `new String('')`)
   *
  ...
  * // => false
  ...
  reWords = (function() {
    ...
    upper = '[A-Z]';
    lower = '[a-z]+';
    return patternp(upper + '+(?=' + upper + lower + ')|' + upper + '?' + lower + '|' + upper + '+|[0-9]+', 'g');
  })();
  ...
  * @return {string} the base64 representation of the URL
  ...
  RangeParam = (function(superClass) {
    ...
    RangeParam.norm_range_value = function(value) {
      var modifier, offset;
      offset = String(value).match(new patternp('^' + offset_any_pattern + '$'));
      if (offset) {
  ...
  Expression = (function() {
    ...
    Expression.normalize = function(expression) {
      ...
      operatorsReplaceRE = new patternp(operatorsPattern, "g");
      ...
      predefinedVarsReplaceRE = new patternp(predefinedVarsPattern, "g");
  ...
  Configuration = (function() {
    ...
    Configuration.prototype.fromEnvironment = function() {
      var cloudinary_url, j, k, len, query, ref1, ref2, ref3, uri, uripattern, v, value;
      cloudinary_url = typeof process !== "undefined" && process !== null ? (ref1 = process.env) != null ? ref1.CLOUDINARY_URL : void 0 : void 0;
      if (cloudinary_url != null) {
        uripattern = /cloudinary:\/\/(?:(\w+)(?:\:([\w-]+))?@)?([\w\.-]+)(?:\/([^?]*))?(?:\?(.+))?/;
        uri = uripattern.exec(cloudinary_url);
        if (uri) {
          if (uri[3] != null) {
