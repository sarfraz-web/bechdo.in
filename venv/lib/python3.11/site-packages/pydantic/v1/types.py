...
class ConstrainedStr(str):
    ...
    def __modify_schema__(cls, field_schema: Dict[str, Any]) -> None:
        update_not_none(
            ...
            pattern=cls.pattern and cls._get_pattern(cls.pattern),
        )
    ...
    def validate(cls, value: Union[str]) -> Union[str]:
        ...
        if cls.pattern:
            if not re.match(cls.pattern, value):
                raise errors.StrpatternError(pattern=cls._get_pattern(cls.pattern))

        return value

    @staticmethod
    def _get_pattern(pattern: Union[str, Pattern[str]]) -> str:
