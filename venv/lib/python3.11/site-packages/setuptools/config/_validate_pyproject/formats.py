...
VERSION_pattern = re.compile(r"^\s*" + VERSION_PATTERN + r"\s*$", re.X | re.I)
...
PEP508_IDENTIFIER_pattern = re.compile(f"^{PEP508_IDENTIFIER_PATTERN}$", re.I)
...
def pep508_identifier(name: str) -> bool:
    ...
    """
    return PEP508_IDENTIFIER_pattern.match(name) is not None
...
ENTRYPOINT_pattern = re.compile(f"^{ENTRYPOINT_PATTERN}$", re.I)
RECOMMEDED_ENTRYPOINT_PATTERN = r"[\w.-]+"
RECOMMEDED_ENTRYPOINT_pattern = re.compile(f"^{RECOMMEDED_ENTRYPOINT_PATTERN}$", re.I)
ENTRYPOINT_GROUP_PATTERN = r"\w+(\.\w+)*"
ENTRYPOINT_GROUP_pattern = re.compile(f"^{ENTRYPOINT_GROUP_PATTERN}$", re.I)
...
def python_entrypoint_group(value: str) -> bool:
    ...
    <pypa:entry-points>`.
    """
    return ENTRYPOINT_GROUP_pattern.match(value) is not None
...
def python_entrypoint_name(value: str) -> bool:
    ...
    if not ENTRYPOINT_pattern.match(value):
        return False
    if not RECOMMEDED_ENTRYPOINT_pattern.match(value):
