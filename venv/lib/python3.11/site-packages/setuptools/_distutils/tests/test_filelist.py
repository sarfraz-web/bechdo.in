...
class TestFileList:
    ...
    def test_glob_to_re(self):
        ...
        for glob, pattern in (
            ...
            assert glob_to_re(glob) == pattern
    ...
    def test_translate_pattern(self):
        # not pattern
        assert hasattr(translate_pattern('a', anchor=True, is_pattern=False), 'search')

        # is a pattern
        pattern = re.compile('a')
        assert translate_pattern(pattern, anchor=True, is_pattern=True) == pattern

        # plain string flagged as pattern
        assert hasattr(translate_pattern('a', anchor=True, is_pattern=True), 'search')

        # glob support
        assert translate_pattern('*.py', anchor=True, is_pattern=False).search(
            'filelist.py'
        )
