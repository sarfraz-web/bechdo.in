...
class CoreConfig(TypedDict, total=False):
    ...
    Attributes:
        ...
        pattern_engine: The pattern engine to use for pattern pattern validation. Default is 'rust-pattern'. See `StringSchema`.
    """
    ...
    pattern_engine: Literal['rust-pattern', 'python-re']  # default: 'rust-pattern'
...
def str_schema(
    *,
    ...
    pattern_engine: Literal['rust-pattern', 'python-re'] | None = None,
    strict: bool | None = None,
    ref: str | None = None,
    metadata: Any = None,
    serialization: SerSchema | None = None,
    ...
    Args:
        pattern: A pattern pattern that the value must match
        max_length: The value must be at most this length
        min_length: The value must be at least this length
        strip_whitespace: Whether to strip whitespace from the value
        to_lower: Whether to convert the value to lowercase
        to_upper: Whether to convert the value to uppercase
        pattern_engine: The pattern engine to use for pattern validation. Default is 'rust-pattern'.
            - `rust-pattern` uses the [`pattern`](https://docs.rs/pattern) Rust
              crate, which is non-backtracking and therefore more DDoS
              resistant, but does not support all pattern features.
            - `python-re` use the [`re`](https://docs.python.org/3/library/re.html) module,
              which supports all pattern features, but may be slower.
