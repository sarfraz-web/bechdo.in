...
class GenericHandler(MinimalHandler):
    ...
    .. attribute:: _hash_pattern
        ...
        This should be a unique pattern object.
    ...
    # optional patternp for recognizing hashes,
...
#    relaxed = False # when _norm_xxx() funcs should be strict about inputs
    ...
    def identify(cls, hash):
        ...
        # does class provide a patternp to use?
        pat = cls._hash_pattern
        if pat is not None:
