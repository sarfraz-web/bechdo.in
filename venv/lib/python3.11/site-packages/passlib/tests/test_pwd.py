...
class WordGeneratorTest(TestCase):
    ...
    def test_general(self):
        ...
        self.assertRaisespattern(TypeError, "(?i)unexpected keyword.*badkwd", genword, badkwd=True)
...
class PhraseGeneratorTest(TestCase):
    ...
    def test_general(self):
        ...
        # malformed keyword should have useful error.
        self.assertRaisespattern(TypeError, "(?i)unexpected keyword.*badkwd", genphrase, badkwd=True)
