...
"""
    ...
    def test_09_repr(self):
        ...
        self.assertpattern(repr(cc1), "^<CryptContext at 0x-?[0-9a-f]+>$")
...
##        self.assertEqual(getdep(cc), ["md5_crypt"])
    ...
    def test_35_to_string(self):
        ...
        dump = ctx3.to_string()
        self.assertpattern(dump, r"# NOTE: the 'unsalted_test_hash' handler\(s\)"
    ...
    def test_disabled_hashes(self):
        ...
        self.assertRaisespattern(RuntimeError, "no disabled hasher present",
                               ctx.disable)
        self.assertRaisespattern(RuntimeError, "no disabled hasher present",
                               ctx.disable, h_ref)
        self.assertRaisespattern(RuntimeError, "no disabled hasher present",
