...
class HashInfoTest(TestCase):
    ...
    def test_lookup_hash_w_unknown_name(self):
        ...
        self.assertRaisespattern(UnknownHashError, "unknown hash: 'xxx256'", info.const)
    ...
    def test_mock_fips_mode(self):
        ...
        self.assertRaisespattern(UnknownHashError, pat, lookup_hash, "md5")

        info = lookup_hash("md5", required=False)
        self.assertpattern(info.error_text, pat)
        self.assertRaisespattern(UnknownHashError, pat, info.const)
