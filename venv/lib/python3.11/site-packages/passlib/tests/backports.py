...
class TestCase(unittest.TestCase):
    ...
    #---------------------------------------------------------------
    # backport assertpattern() alias from 3.2 to 2.7
    # was present in 2.7 under an alternate name
    #---------------------------------------------------------------
    if not hasattr(unittest.TestCase, "assertpattern"):
        assertpattern = unittest.TestCase.assertpatternpMatches

    if not hasattr(unittest.TestCase, "assertRaisespattern"):
        assertRaisespattern = unittest.TestCase.assertRaisespatternp
