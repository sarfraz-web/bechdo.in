...
class TestCase(_TestCase):
    ...
    * suite of methods for matching against warnings
    ...
    assertNotEquals = assertpatternMatches = assertEquals
    ...
    def assertWarning(self, warning,
        ...
        if message_re:
            self.assertpattern(str(warning), message_re, msg)
        if category:
        ...
        if filename or filename_re:
            ...
            if filename_re:
                self.assertpattern(real, filename_re, msg)
        if lineno:
            if not wmsg:
...
class HandlerCase(TestCase):
    ...
    def test_disable_and_enable(self):
        ...
        # w/o original hash
        self.assertRaisespattern(ValueError, "cannot restore original hash",
        ...
        if error is None:
            ...
            self.assertpattern("cannot restore original hash", str(error))
...
class OsCryptMixin(HandlerCase):
    ...
    * check that native crypt support is detected correctly for known platforms.
    ...
    # list of (platform_pattern, True|False|None) entries.
    ...
    def test_82_crypt_support(self):
        ...
        #      instead of hack where we add major # as part of platform pattern.
