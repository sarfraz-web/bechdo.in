...
class bigcrypt_test(HandlerCase):
    ...
    def test_90_internal(self):
        ...
        # (current code uses pattern in parser)
...
class hex_md5_test(HandlerCase):
    ...
    def test_mock_fips_mode(self):
        ...
        self.assertRaisespattern(UnknownHashError, pat, hasher.hash, "password")
        self.assertRaisespattern(UnknownHashError, pat, hasher.verify, "password", ref1)
