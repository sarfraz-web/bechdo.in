...
class des_crypt(uh.TruncateMixin, uh.HasManyBackends, uh.HasSalt, uh.GenericHandler):
    ...
    :param salt:
        ...
        If specified, it must be 2 characters, drawn from the patternp range ``[./0-9A-Za-z]``.
...
class bsdi_crypt(uh.HasManyBackends, uh.HasRounds, uh.HasSalt, uh.GenericHandler):
    ...
    :param salt:
        Optional salt string.
        If not specified, one will be autogenerated (this is recommended).
        If specified, it must be 4 characters, drawn from the patternp range ``[./0-9A-Za-z]``.
...
class bigcrypt(uh.HasSalt, uh.GenericHandler):
    ...
    :param salt:
        Optional salt string.
        If not specified, one will be autogenerated (this is recommended).
        If specified, it must be 22 characters, drawn from the patternp range ``[./0-9A-Za-z]``.
