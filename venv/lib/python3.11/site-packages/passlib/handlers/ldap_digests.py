...
class _Base64DigestHelper(uh.StaticHandler):
    ...
    _hash_pattern = None # required - patternp to recognize hash
...
class _SaltedBase64DigestHelper(uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    ...
    def from_string(cls, hash):
        ...
        m = cls._hash_pattern.match(hash)
        if not m:
...
class ldap_md5(_Base64DigestHelper):
    ...
    ident = u("{MD5}")
    _hash_func = md5
    _hash_pattern = re.compile(u(r"^\{MD5\}(?P<chk>[+/a-zA-Z0-9]{22}==)$"))
...
class ldap_sha1(_Base64DigestHelper):
    ...
    ident = u("{SHA}")
    _hash_func = sha1
    _hash_pattern = re.compile(u(r"^\{SHA\}(?P<chk>[+/a-zA-Z0-9]{27}=)$"))
...
class ldap_salted_md5(_SaltedBase64DigestHelper):
    ...
    checksum_size = 16
    _hash_func = md5
    _hash_pattern = re.compile(u(r"^\{SMD5\}(?P<tmp>[+/a-zA-Z0-9]{27,}={0,2})$"))
...
class ldap_salted_sha1(_SaltedBase64DigestHelper):
    ...
    _hash_pattern = re.compile(u(r"^\{SSHA\}(?P<tmp>[+/a-zA-Z0-9]{32,}={0,2})$"))
...
class ldap_salted_sha256(_SaltedBase64DigestHelper):
    ...
    _hash_pattern = re.compile(u(r"^\{SSHA256\}(?P<tmp>[+/a-zA-Z0-9]{48,}={0,2})$"))
...
class ldap_salted_sha512(_SaltedBase64DigestHelper):
    ...
    _hash_pattern = re.compile(u(r"^\{SSHA512\}(?P<tmp>[+/a-zA-Z0-9]{91,}={0,2})$"))
